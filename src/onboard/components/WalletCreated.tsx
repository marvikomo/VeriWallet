...
const WalletCreated = () => {
  ...
  <div className="max-w-lg mx-auto text-center p-8 bg-gray-800 rounded-lg">
    <div className="mb-4">
      ...
      <img src="/path-to-your-metamask-logo.svg" alt="MetaMask" className="mx-auto mb-4" />
      <h1 className="text-xl text-white font-semibold mb-3">VeriWallet creation successful</h1>
      <p className="text-gray-400 text-sm">You’ve successfully protected your wallet. Keep your Secret Recovery Phrase safe and secret - it's your responsibility!</p>
    </div>

    <div className="text-left text-gray-400 text-sm mb-6">
      <ul>
        <li className="mb-2">VeriWallet can’t recover your Secret Recovery Phrase.</li>
        <li className="mb-2">VeriWallet will never ask you for your Secret Recovery Phrase.</li>
        <li className="mb-2">Never share your Secret Recovery Phrase with anyone or risk your funds being stolen.</li>
        <li className="mb-2">
